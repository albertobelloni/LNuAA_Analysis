...
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_electron_2012d_Jan22rereco process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_muon_2012a_Jan22rereco process_all_${timestamp}/
...
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_WWZ process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_WW_2l2nu process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_WWg process_all_${timestamp}/
...
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ZZ_2l2nu process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ZZ_2l2q process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ZZ_2mu2tau process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ZZ_2q2nu process_all_${timestamp}/
...
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ggH_125 process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ggZZ_2l2l process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ggZZ_4l process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_t_s process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_t_t process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_t_tW process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_tbar_s process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_tbar_t process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_tbar_tW process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttW process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttZ process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttg process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttinclusive process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttjets_1l process_all_${timestamp}/
process_ntuple ../python/LNuAA_BasicSelectionAnalysis.py job_summer12_ttjets_2l process_all_${timestamp}/
